...
&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;13. asset_bundle : bundle銷售的資訊，此欄位保留opensea api 原始json欄位，沒有特別處理。此欄位也是造成data crawler產生的檔案，會需要修復的原因，因含有特殊字符。<br>
...
&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;21. msg : SOMTHING WRONG、Fail-no asset_events代表這筆 wallet_address_input 沒有執行抓完，應整個檔案的此筆wallet_address_input都刪除。<br>
